...
service AcquireStoreService{
 ...
 i32 					start(1: i32 display_frame_rate),
 i32 					stop(),
 i32					set_display_frame_rate(1: i32 display_frame_rate, 2: i32 grab_frame_rate),
 i32					set_store_file(1: i32 flag),
 i32					do_pause(1: i32 flag),
 
 //temporary play 
 //i32          temporary play forward or backward
 
 i32					forward_play(1: i64 frame_seq, 2: i32 display_frame_rate),
 i32					backward_play(1: i64 frame_seq, 2: i32 display_frame_rate),
