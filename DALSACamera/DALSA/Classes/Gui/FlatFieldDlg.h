...
private:
   void DarkImage();
   void BrightImage();
   void LogMessage(int messageType, const char* string);
   void LogMessage(int messageType, CString string);
	
	CStringA GetAverageStr( SapFlatFieldStats& stats) const;
	CStringA GetStdDeviationStr( SapFlatFieldStats& stats) const;
	CStringA GetLowStr( SapFlatFieldStats& stats) const;
	CStringA GetHighStr( SapFlatFieldStats& stats) const;
	CStringA GetPixelRatioStr( SapFlatFieldStats& stats) const;
	CStringA GetNumPixelsStr( SapFlatFieldStats& stats) const;
	CStringA GetPeakPositionStr( SapFlatFieldStats& stats) const;
