...
public:
   ...
   void SetPixelStringFormatDecimal(BOOL bDecimal = TRUE);
   static CString GetPixelString(SapBuffer* pBuffer, CPoint point, BOOL decimalDisplay = FALSE, BOOL displayCoordinates = TRUE);
...
protected:
	...
	CRect					m_roi;
   BOOL              m_PixelStringFormatDecimal;
